<?php 
$pagina = basename($_SERVER['PHP,SELF']);
$navItems = [
  'Inicio' => 'index.php',
    ...
    <header class="bg-danger text-white py-lg-5 position-fixed w-100">
        ...
        <div class="hero container-fluid p-0">
            <div class="hero-content position-absolute top-50 start-50 translate-middle text-center text-white">
                <a href="cardapio.html" class="btn btn-primary btn-warning btn-lg icon-link-hover">Ver Cardápio</a>
                <a href="pedido.html"
                    class="btn btn-danger btn-outline-danger btn-lg icon-link-hover text-light-emphasis">ifood</a>

            </div>
        </div>
    </header>
    <section id="inicio" class="section py-5 bg-light-subtle">
        <div class="container">
            <div class="mural-logo">
            </div>
        </div>
    </section>
